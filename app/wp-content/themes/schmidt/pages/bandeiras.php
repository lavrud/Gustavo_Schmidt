...
<body>
                            ...
                            <div class="col-lg-6 col-sm-12 p-2">
                                <li>
                                    <figure class="imghvr-hinge-right">
                                        <img src="./src/img/bandeira_gustavojpg.jpg" class="img-fluid" width="500"
                                            height="250" alt="Thumb">
                                        <figcaption>
                                            <a href="#">
    ...
    <section class="proporsal-clean">
        <div class="container">
            ...
            <div class="proporsal p-5 row">

                <div class="col-sm-6 col-lg-4 d-flex">
                    <i class="fas fa-angle-right my-4 text-primary" aria-hidden="true"></i>
                    <p class="description p-3">Vivamus hendrerit ac erat eget consequat nam rhoncus nisl at dapibus</p>
                </div>
