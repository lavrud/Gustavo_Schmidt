    ...
    <header id=#top>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white shadow">
            <div class=" container">
                ...
                <!-- Logo -->
                <a class="navbar-brand" href="/index.html"><img src="./src/img/logo_gustavo.jpg" class="img-fluid"
        ...
        <div id="banner-hero">
            <div class="container">
                <div class="text-banner">
                    <h1 class="text-one col-lg-6 col-sm-4 display-2">Sigamos<br>juntos.</h1>
                </div>
            </div>
        </div><!-- banner-hero -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-12 mb-3">
                    <a href="http://">
                        <div class="action-col">
                            <h5 class="action-title">conheça minhas propostas</h5>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-4 col-sm-12 mb-3">
                    <a href="http://">
                        <div class="action-col">
                            <h5 class="action-title">participe do meu mandato</h5>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-4 col-sm-12 mb-3">
                    <a href="http://">
                        <div class="action-col">
                            <h5 class="action-title">brasil brasileiro</h5>
                        </div>
                    </a>
                </div>
        ...
        <div class="container">
            <div class="about-border">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <h4>sobre</h4>
                        <h2>lorem ipsum imet out sumot</h2>
                        <p class="text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae ab
                            voluptates
                        ...
                        <a class="btn btn-metro" href="http://" role="button">Conheça o Deputado</a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <div class="mt-5" style="margin-bottom: 25px" ;>
                        <h4 class="text-white">mídia</h4>
                        <h2 class="text-white">lorem ipsum imet out sumot</h2>
                    </div>
                    ...
                    <div class="shadow mb-4">
                        ...
                        <a href="http://">
                            <figure class="figure">
                                <img class="img-fluid" alt="" src="./src/img/bandeira_gustavojpg.jpg">

                                <div class="d-flex justify-content-between align-items-center bg-white">
                                    <figcaption class="figure-caption text-justify text-dark"
                                        style="flex: 1 1 auto; min-height: 1px; padding: 1.25rem; font-size: 14px; font-weight: 400;">
                                        <h6>Título</h6>
                                        Este é um card maior e que suporta texto abaixo, como uma introdução mais
                                        natural.
                                    </figcaption>
                                </div>
                            </figure>
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <button class="btn btn-outline-media shadow mt-5 mb-5 float-right pt-2 pb-2 pl-5 pr-5">
                        <strong>Ir para Mídia</strong>
                    </button>
    ...
    <section id="flags">
        <div class="container pb-5">
            ...
            <div class="row">
                    ...
                    <a href="http://">
                        <figure class="figure shadow mb-5">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <i class="fa fa-long-arrow-right lead mr-3" style="color: #233F94;"
                                    aria-hidden="true"></i>
                            </div>
                ...
                <button type="submit"
                    class="btn btn-outline-flags shadow d-flex mx-auto pt-2 pb-2 pl-5 pr-5"><strong>Ver todas</strong></button>
                ...
                <div class="col-lg-6 mx-auto col-sm-12">
                    <form method="POST" action="#">
                        ...
                        <div class="form-group">
                            <img src="./src/img/icon-planing.png" alt="">
                            <input type="text" class="form-control" name="inputEmail" id="inputEmail"
                                placeholder="Insira seu e-mail:">
                        </div>

                        <div class="form-group pt-2">
                            <img src="./src/img/icon-architecture.png" alt="">
                        ...
                        <button type="submit"
                            class="btn btn-outline-news shadow d-flex mx-auto pt-2 pb-2 pl-5 pr-5"><strong>Enviar</strong></button>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <a href="#top" class="brand-footer img-fluid">
                        <img src="./src/img/logo_gustavo.jpg" alt="">
                    </a>
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="address-footer">
                        ...
                        21<span style="text-transform: uppercase;">2588.1284 | 97004.3544</span>
                        <br /><br />
                        <span>ENDEREÇO</span>
                        <p>palácio 23 de julho, s/nº Gab, 107, praça XV.<br>
